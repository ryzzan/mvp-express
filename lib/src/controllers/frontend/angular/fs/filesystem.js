...
var FileSystem = /** @class */ (function () {
    function FileSystem() {
        ...
        this.createProjectComponentPathAndFile = function (projectPath, componentPath, componentCode, componentCodeType, isNest) { return __awaiter(_this, void 0, void 0, function () {
            var projectFolder, splitProjectFolder, projectFolderParent, projectAndComponentPath, nodeModulePath, componentPathAsClass, projectAndComponent, error_1, error_2, file, newFile, newFileImport, menu, newMenu, newMenuImport, mainRoutingCodeSplit, mainRoutingCodeImportSplit, menuCodeSplit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        projectFolder = projectPath.split(/[\/]+/).pop(), splitProjectFolder = projectPath.split(/[\/]+/), projectFolderParent = splitProjectFolder.slice(0, splitProjectFolder.length - 1).join('/'), projectAndComponentPath = projectPath + "/src/app/components/" + componentPath, nodeModulePath = projectPath + "/node_modules", componentPathAsClass = this.sharedFunction.setIdToClassName(componentPath);
                        try {
                    ...
                    case 9:
                        if (isNest) {
                            ...
                            file = fs.readFileSync(projectPath + "/src/app/modules/main/main-routing.module.ts"), newFile = file.toString().replace('children: [', "children: [{path: '" + componentPath + "', component: " + componentPathAsClass + "Component},"), newFileImport = newFile.replace("import { MainComponent } from './main.component';", "import { MainComponent } from './main.component'; import { " + componentPathAsClass + "Component } from '../../components/" + componentPath + "/" + componentPath + ".component';"), menu = fs.readFileSync(projectPath + "/src/app/modules/main/main.component.ts"), newMenu = menu.toString().replace('menu = [', "menu = [{router: '/main/" + componentPath + "',title: 'Mudar',icon: 'dashboard',itens: [],},"), newMenuImport = newMenu.replace("import { MainComponent } from './main.component';", "import { MainComponent } from './main.component'; import { " + componentPathAsClass + "Component } from '../../components/" + componentPath + "/" + componentPath + ".component';");
                            try {
                                mainRoutingCodeSplit = file.toString().split("component: " + componentPathAsClass + "Component"), mainRoutingCodeImportSplit = file.toString().split(componentPathAsClass + "Component"), menuCodeSplit = menu.toString().split("router: '/main/" + componentPath + "'");
