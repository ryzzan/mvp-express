        ...
        this.setClassConstructor = function (object) {
            ...
            var _loop_1 = function (property) {
                if (Object.prototype.hasOwnProperty.call(object, property)) {
                    ...
                    if (property === 'table') {
                        var tableObject_1 = object[property];
                        for (var element in tableObject_1) {
                            if (Object.prototype.hasOwnProperty.call(tableObject_1, element)) {
                                if (element === 'elements') {
                                    var elements = tableObject_1.elements;
                                    elements.forEach(function (tag) {
                                        if (tag.row) {
                                            if (tag.row.menu) {
                                                var menus = tag.row.menu;
                                                menus.forEach(function (menu) {
                                                    if (menu.dialog) {
                                                        var dialogTemplateAsClassName = _this.sharedFunction.setIdToClassName(menu.dialog.templateFolder), tableIdAsPropertyName = _this.sharedFunction.setIdToPropertyName(tableObject_1.id);
            ...
            for (var key in object) {
                if (Object.prototype.hasOwnProperty.call(object, key)) {
                    ...
                    if (key === 'table') {
                        ...
                        if (table) {
                            var tableClassName = _this.sharedFunction.setIdToClassName(table.id), tablePropertyName = _this.sharedFunction.setIdToPropertyName(table.id), tableMetaObject = { className: tableClassName, propertyName: tablePropertyName };
        ...
        this.setForm = function (form, formMetaObject) {
            ...
            for (var element in form) {
                if (Object.prototype.hasOwnProperty.call(form, element)) {
                    if (element === 'elements') {
                        var elements = form[element];
                        codeElements += _this.setFormElements(elements, formMetaObject);
                    }
                }
            }
            return codeElements;
            ...
            for (var element in table) {
                if (Object.prototype.hasOwnProperty.call(table, element)) {
                    if (element === 'elements') {
                        ...
                        codeElements += _this.setTableElements(elements, tableMetaObject);
                    }
                }
            }
            return codeElements;
        ...
        this.setTableElements = function (elements, tableMetaObject) {
            ...
            elements.forEach(function (object) {
                for (var key in object) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(object, key)) {
                        if (key === 'row') {
                            var row = object[key], menus = row.menu;
