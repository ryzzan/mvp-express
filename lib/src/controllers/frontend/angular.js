...
var CodeToAngular = /** @class */ (function () {
    function CodeToAngular() {
        ...
        this.setAngularCode = function (objectToCode) { return __awaiter(_this, void 0, void 0, function () {
            var codeTemplate, codeDirective, codeInterface, form, table, nest, importObject, formIdAsClassName, formPropertyName, importObject, tableIdAsClassName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        codeTemplate = '', codeDirective = '', codeInterface = '';
                        form = objectToCode.form, table = objectToCode.table, nest = objectToCode.nest;
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6:
                        if (!nest) return [3 /*break*/, 8];
                        nest.components.forEach(function (res) { return codeTemplate += "<app-" + res + "></app-" + res + ">"; });
                        console.info('Enviado código de template para tratar na arquitetura.');
                        return [4 /*yield*/, this.fs.createProjectComponentPathAndFile(objectToCode.projectPath, nest.id, codeTemplate, frontend_1.ComponentCodeType.Template, true)];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    case 8:
