    ...
    function CodeToAngular() {
        ...
        this.setFormDirective = function (formArray) {
            ...
            formArray.forEach(function (form) {
                ...
                codeForm += _this.setFormDirectiveElement(array, formIdAsPropertyName);
                codeForm += "});";
                // Create code: submit
                array.forEach(function (element) {
                    var _a, _b, _c, _d, _e;
        ...
        this.setFormDirectiveElement = function (array, formIdAsPropertyName, isArray) {
            ...
            array.forEach(function (element) {
                ...
                if (element.array) {
                    ...
                    codeForm += _this.setFormDirectiveElement(element.array.elements, formIdAsPropertyName, true);
                    codeForm += "})]),";
                }
                ...
                if ((_k = (_j = element.select) === null || _j === void 0 ? void 0 : _j.options) === null || _k === void 0 ? void 0 : _k.object) {
                    codeForm += "'" + ((_l = element.select) === null || _l === void 0 ? void 0 : _l.name) + "': new FormControl(" + (((_m = element.select) === null || _m === void 0 ? void 0 : _m.defaultValue) ? "'" + ((_o = element.select) === null || _o === void 0 ? void 0 : _o.defaultValue) + "'" : null) + ", [" + (required ? 'Validators.required,' : '') + " " + (typeEmail ? 'Validators.email,' : '') + "]), ";
                }
            });
            return codeForm;
        };
